...
\begin{frame}{Funktionen als Objekte}
	...
	\lstinputlisting[firstline=0,lastline=3]{resources//08_unpacking_lambda/idea_example_lambda.py}
	Kann man die klassische Funktionsdefinition direkt als Argument reingeben ? \alert{NEIN! (und es sieht komisch aus)}
	\lstinputlisting[firstline=6,lastline=10]{resources//08_unpacking_lambda/idea_example_lambda.py}
	Stattdessen:
	\lstinputlisting[firstline=4,lastline=4]{resources//08_unpacking_lambda/idea_example_lambda.py}	
\end{frame}
...
\begin{frame}{Lambda Funktionen}
	...
	\codeline{lambda} Funktionen verhalten sich wie gewöhnliche Funktionen, nur das sie in einer Zeile definiert werden können und damit keinen Namen brauchen. Deshalb nennt man sie auch \alert{anonyme Funktionen}.
\end{frame}

\begin{frame}{Lambda Funktionen}
	Beispiel \codeline{map}
