...
\begin{frame}{\_\_name\_\_ == '\_\_main\_\_'}
	...
	Wird es nur importiert, so hat die Variable einen anderen Wert. Dadurch wird das durch die \codeline{if}-Abfrage geschützte Codesegment nicht mit ausgeführt.
\end{frame}
