...
\begin{frame}{Listen - Initialisierung}
	Initialisierung
	\lstinputlisting[firstline=0,lastline=5]{resources/02iteration/list.py}
	Listen sind geordnete Datenstrukturen:
	\lstinputlisting[firstline=7,lastline=10]{resources/02iteration/list.py}
\end{frame}
\begin{frame}{Listen - append/remove}
	\lstinputlisting[firstline=2,lastline=2]{resources/02iteration/list.py}
	\lstinputlisting[firstline=12,lastline=15]{resources/02iteration/list.py}
	\lstinputlisting[firstline=16,lastline=18]{resources/02iteration/list.py}
\end{frame}
